...
/**
 * Utilities class containing all the request data
 *
 */
class Request
{
     ...
     * @var String
     */
    private $_controllerActionMethod;
    /***
     * Utilities method (RequestMethod ENUM)
     * @var RequestMethod
     */
    private $_method;
    /***
    ...
    /***
     * Set controller action method
     *
     * @param $actionMethod
     */
    public function setControllerActionMethod($actionMethod)
    {
        $this->_controllerActionMethod = $actionMethod;
    }
    /***
     ...
     * @return String
     */
    public function getControllerActionMethod()
    {
        return $this->_controllerActionMethod;
    }
}